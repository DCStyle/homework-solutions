...
class BookChapter extends Model
{
    ...
    public function getDescriptionSnippet($length = 100)
    {
        if (!$this->description) {
            ...
            return trim("Soạn bài, giải bài tập tất cả các môn học  - $this->name - {$this->book->group->name} {$this->book->group->category->name} trên $siteName, cách trình bày dễ hiểu, khoa học.");
        }
