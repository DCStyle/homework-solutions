...
@section('title', isset($category) ? 'Cập Nhật Danh Mục' : 'Thêm Danh Mục Mới')
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 relative z-10">
                <div>
                    ...
                    <p class="mt-1 text-white/90">
                        {{ isset($category) ? 'Chỉnh sửa thông tin danh mục' : 'Tạo danh mục mới cho website' }}
                    </p>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    @endif
                    <a href="{{ route('admin.categories.index') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-white/20 py-2.5 px-4 text-center font-medium text-white hover:bg-white/30 transition-all duration-200">
            ...
            <form method="POST"
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <p class="mt-1 text-xs text-gray-500 flex items-center">
                                ...
                                Đường dẫn sẽ xuất hiện trên URL: example.com/categories/<span class="font-mono text-primary">duong-dan</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                        <a href="{{ route('admin.categories.index') }}" class="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white py-3 px-6 text-center font-medium text-gray-700 hover:bg-gray-100 transition-all duration-200 shadow-sm">
