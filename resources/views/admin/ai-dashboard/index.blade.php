...
@section('content')
        ...
        <div class="relative overflow-hidden rounded-xl bg-primary p-6 shadow-lg">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 relative z-10">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.ai-dashboard.jobs') }}" class="inline-flex items-center justify-center gap-2.5 rounded-lg bg-white py-3 px-5 text-center font-medium text-primary hover:bg-gray-100 transition-all duration-200 transform hover:scale-105 shadow-md lg:px-6">
                        <span class="iconify" data-icon="mdi-checkbox-marked-circle-auto-outline"></span>
                        Danh sách tác vụ
                    </a>
                </div>
            </div>
    ...
    <!-- Create Prompt Modal - Custom implementation -->
    <div id="createPromptModal" class="modal fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="createPromptModalLabel" aria-hidden="true">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="modal-content transform transition-all opacity-0 scale-95 bg-white rounded-xl shadow-xl w-full max-w-lg">
                <div class="modal-header flex items-center justify-between p-4 bg-primary text-white rounded-t-xl">
                ...
                <form id="createPromptForm" action="{{ route('admin.ai-dashboard.save-prompt') }}" method="POST" class="p-2">
                    ...
                    <div class="modal-footer flex items-center justify-end p-4 border-t border-gray-200 space-x-3">
                        <button type="button" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50" data-dismiss="modal">
                            <svg class="w-5 h-5 inline-block mr-1 align-text-bottom" viewBox="0 0 24 24"><path fill="currentColor" d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z" /></svg>
                            Hủy
                        </button>
                        <button type="submit" class="px-4 py-2 bg-primary text-white rounded-md hover:bg-primary/90">
                            <svg class="w-5 h-5 inline-block mr-1 align-text-bottom" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
                            Tạo Mẫu
                        </button>
                    </div>
                </form>
