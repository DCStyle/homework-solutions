                    ...
                    <tbody>
                        @foreach($jobs as $job)
                            <tr class="hover:bg-gray-50 job-row 
                                    {{ $job->status === 'completed' ? 'bg-green-50/30' : 
                                        ($job->status === 'failed' ? 'bg-red-50/30' : 
                                        ($job->status === 'replaced' ? 'bg-gray-50/50' : '')) }}" 
                                id="job-row-{{ $job->id }}">
                                            ...
                                            <div class="h-2 w-full rounded-full bg-gray-200">
                                                <div class="h-full rounded-full 
                                                        {{ $job->status === 'completed' ? 'bg-green-500' : 
                                                            ...
                                                            ($job->status === 'replaced' ? 'bg-gray-500' : 'bg-indigo-600')) }}" 
                                ...
                                <td class="border-b border-gray-200 py-4 px-4">
                                    ...
                                    <div class="mt-1 text-xs text-gray-500">
                                        @if($job->status === 'completed' || $job->status === 'failed' || $job->status === 'replaced')
