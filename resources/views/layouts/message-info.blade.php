<div class="flex w-full border-l-6 border-[#ffa70b] bg-[#ffa70b26] p-4 mb-6 shadow-md">
    <div class="mr-5 flex h-9 w-9 items-center justify-center rounded-lg bg-[#ffa70b26]">
    ...
    <div class="w-full">
        ...
        <p class="leading-relaxed text-[#D0915C]">{!! $message !!}</p>
    </div>
</div>
