...
@seo(['title' => $group->name . ' ' . $category->name])
    ...
    <div class="flex justify-between">
        ...
        <div class="mx-auto p-6 min-w-0 w-full max-xl:p-4 max-md:p2">
            ...
            <div class="mt-4 bg-white p-4 text-md text-green-700 border shadow-md">
                <h2 class="text-xl">{!! ($group->description && strlen(trim($group->description)) > 0)
                        ? $group->description
                        : "Dưới đây là toàn bộ bài giải <b class='text-black'>$group->name $category->name</b>.
